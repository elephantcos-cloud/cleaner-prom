...
class PermissionsActivity : BaseActivity() {
    ...
    private fun buildList() {
        ...
        data class Perm(val icon: Int, val title: String, val desc: String, val ok: Boolean, val action: () -> Unit)

        val perms = listOf(
            Perm(R.drawable.ic_apps, getString(R.string.perm_storage), getString(R.string.perm_storage_desc),
                checkStorage()) { reqStorage() },
            Perm(R.drawable.ic_clean, getString(R.string.perm_usage), getString(R.string.perm_usage_desc),
                StorageHelper.hasUsageStatsPermission(this)) {
                startActivity(Intent(Settings.ACTION_USAGE_ACCESS_SETTINGS))
            },
            Perm(R.drawable.ic_sleep, getString(R.string.perm_accessibility), getString(R.string.perm_accessibility_desc),
        ...
        perms.forEach { perm ->
            val card = LinearLayout(this).apply {
                ...
                background = GradientDrawable().apply {
                    ...
                    setStroke(1, if (perm.ok) Color.parseColor("#1E5E1E") else ThemeHelper.dividerColor(this@PermissionsActivity))
                }
            ...
            card.addView(android.widget.ImageView(this).apply {
                ...
                imageTintList = android.content.res.ColorStateList.valueOf(
                    if (perm.ok) Color.parseColor("#4CAF50") else ThemeHelper.textSecondary(this@PermissionsActivity))
